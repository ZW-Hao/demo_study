...
<div class="container">
    ...
    <form id="userForm" action="${pageContext.request.contextPath}/delSeleteUser" method="post">
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${queryResult.list}" var="user" varStatus="s">
                <tr>
    ...
    <div>
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <c:if test="${queryResult.currentPage==1}">
                    <li class="disabled">
                </c:if>
                <c:if test="${queryResult.currentPage!=1}">
                    <li >
                ...
                <c:forEach begin="1" end="${queryResult.totalPage}" var="i">
                    <c:if test="${queryResult.currentPage==i}">
                        <li class="active"><a
                ...
                <br><br>
                <span>
                    共${queryResult.totalCount}条记录，共${queryResult.totalPage}页
                </span>
            </ul>
        </nav>
    </div>
